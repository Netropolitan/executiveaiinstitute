---
title: "Why Our Human-Centric Approach to AI Upskilling Beat the Tech Hype (and Scored 9.7/10 NPS)"
description: "Human-centred AI upskilling shows that clarity, intent and creativity, not tools, drive impact, boosting confidence, efficiency and daily AI use."
pubDate: 2025-11-29
author: jamie
readMinutes: 10
---
...
Over six months, I ran an AI Upskills programme with Insights. Participants were mostly in learning experience design roles, not from tech teams. We met for just over an hour a week, split over two sessions, and we designed the whole thing around human skills and clear intent, not around specific tools.
...
- Critical thinking to check, refine and challenge outputs
- Communication and collaboration to bring others along

We spent a lot of time in this cohort talking about that shift: expertise is now on demand. If something is repetitive, rules-based or pattern-heavy, machines will do it better. Our edge is how we frame problems, set intent and shape value.

One of my favourite moments was when a participant didn't type a prompt at all. They drew what they wanted, a rough sketch of an infographic, snapped a picture, and asked the AI to turn that drawing into the professional visual they had in mind. No immaculate prompt. Just clear intent, expressed in their natural way.
...
- How generative AI works (without the maths headache, since you don't need to understand email protocols to send an email)
- Public narrative and storytelling with AI (storytelling is a human superpower; clear narrative helps you get better results from AI)
...
Participants rated their own confidence and agreement with specific statements on a 1-6 scale. Things like:
...
- "AI feels approachable and easy to experiment with."

After five months, they looked back and rated where they are now against where they were at the start. We also asked how often they now use AI, how much time they save each week, their intention to apply AI use cases in the next 30 days, and how likely they were to recommend the sessions to a colleague.

This wasn't my opinion. It was their lived experience.

## Six Numbers That Tell the Story

1. **9.7/10 Net Promoter Score**: people were highly likely to recommend the programme, not merely content with it.
2. **115% increase in confidence choosing the right AI tool**: average scores went from 1.86 to 4.00 out of 6.
3. **86% now use AI daily (up from 57%)**: AI moved from theory to daily practice.
4. **Most participants save 2-4 hours every week using AI**, and 86% report saving at least 2 hours weekly.
5. **A 76% jump in seeing AI as relevant across most job roles**: a shift from "AI is for tech people" to "AI is for my work".
6. **88% strongly agreed** their organisation was proactively supporting their personal development and future skills.

And underneath those six headline stats, there's a deeper story.

## Confidence and Core Skills: People Took the Wheel

We saw significant improvements across all the core skills we measured: confidence using AI tools in their role, writing prompts and instructions, reviewing AI outputs for accuracy and bias, and explaining AI concepts to colleagues.
...
The biggest jumps in understanding were in how AI affects their role and team, where AI adds value versus creates risk, and awareness of data privacy, security and compliance.
...
So we spent a lot of time on task clarity: breaking work down into steps, separating thinking work from formatting work, and asking "where exactly could AI help here?"

The results showed big lifts in the belief that AI makes work more efficient, clarity on 2-3 tasks to streamline with AI, confidence integrating AI into daily workflows, and seeing AI as more of an opportunity than a risk. And then the punchline: most participants report saving 2-4 hours every week, and a few are saving even more.

Those aren't mythical "consulting hours"; they're real, person-reported gains.

## Quality, Creativity and Problem-Solving

One of my priorities was to show that AI isn't just a faster way to type. Used well, it's a powerful thinking partner. We saw:

- A 100% increase in using AI for creative idea generation
- Strong gains in using AI to plan and structure projects
- Improved quality of written and analytical work
- Higher confidence in summarising and analysing information with AI
- Better support for evidence-based decision making

We did live experiments: turning half-formed ideas into structured plans, asking AI to critique our own thinking and develop strategies, using AI to generate multiple perspectives before making a decision.
...
A lot of AI programmes touch ethics on the last slide. We built it into the spine of the curriculum: awareness of harms like bias, exclusion and misinformation; confidence applying fairness, accountability and transparency principles; stronger awareness of accessibility requirements; and designing content and services with inclusion in mind.
...
AI can be a lonely topic. People worry about sounding foolish, or "using it wrong". By the end of the programme the story was different:

- People felt more comfortable discussing AI with colleagues
- Sharing AI tips and examples became normal
- Comfort with experimenting and learning in public rose
- Teams discussed AI use, risk and good practice more often
...
Research from IBM, Deloitte and the World Economic Forum shows that the half-life of professional skills has fallen from around 10-15 years to about 5, and for technical skills to roughly 2.5 years. You would not want a surgeon who has not updated their skills since 2016, so why are we comfortable with the same in our own jobs?
...
- Curious and creative in exploring possibilities
- Grounded in ethics, accessibility and inclusion
- Confident enough to teach AI to use other AI tools, and to say "no" when it's the wrong fit

That's what we built with this programme. And, importantly, we did it with people in traditionally non-technical roles.

This is why I believe AI upskilling has to start from a human-centric lens. When you invest in clarity, curiosity, creativity, communication and collaboration, AI becomes a force multiplier. When you skip those and start with tools, AI becomes another expensive headache.
...
- What would it look like to invest in human-centric AI skills first, and let our tool choices follow?
